...
const Navbar = () => {
  return (
    <nav className="bg-blue-500 fixed w-full top-0 z-99 shadow-xl">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-multi-level">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-blue-400 rounded-lg bg-blue-500 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
              <Link
                to="/"
                className="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-white md:p-0"
                aria-current="page"
              >
                Beranda
              </Link>
            ...
            <li>
              ...
              <div
                id="dropdownNavbar"
                className="z-10 hidden font-normal bg-blue-500 divide-y divide-blue-400 rounded-lg shadow-sm w-44"
              >
                <ul className="py-2 text-sm text-white" aria-labelledby="dropdownLargeButton">
                  ...
                  <li aria-labelledby="dropdownNavbarLink">
                    ...
                    <div
                      id="doubleDropdown"
                      className="z-10 hidden bg-blue-500 divide-y divide-blue-400 rounded-lg shadow-sm w-44"
                    >
            ...
            <li>
              <a
                href="#"
                className="block py-2 px-3 text-white rounded-sm hover:bg-blue-600 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0"
              >
                Services
              </a>
            </li>
